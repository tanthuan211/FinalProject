...
const SignIn = () => {
  ...
  return (
    <View style={{ flex: 1 }}>
      <TouchableOpacity activeOpacity={1} style={{ flex: 1, backgroundColor: color.WHITE }} onPress={Keyboard.dismiss}>
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : undefined} style={{ flex: 1 }}>
          <Formik
            initialValues={{
              email: 'tanthuan211@gmail.com',
              password: '123456789',
            }}
              ...
              <React.Fragment>
                ...
                <View style={{ flex: 0, justifyContent: 'flex-start', padding: 16 }}>
                  ...
                  <View
                    ...
                    <Text style={{ color: color.TITLE}}>Quên mật khẩu?</Text>
                  </View>
                </View>
                <Animatable.View animation="slideInUp" duration={1000} style={{ flex: 1, padding: 16, justifyContent: 'flex-end' }}>
                  ...
                  <Touch
                    ...
                    <View style={{ alignItems: 'center', padding: 12 }}>
                      <Text style={{ color: color.LINK }}>Bạn chưa có tài khoản? Đăng ký</Text>
                    </View>
                  </Touch>
                </Animatable.View>
              </React.Fragment>
